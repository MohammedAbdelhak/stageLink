<x-settings.layout :heading="'Department Assignment'" :subheading="__('')">
    <div class="max-w-xl mx-auto space-y-6">
        ...
        {{-- Submit Button --}}
        <div class="pt-4">
            <button wire:click="submitAssignment" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Submit Assignment
            </button>
        </div>
    ...
    <div class="max-w-xl mx-auto space-y-6 mt-6">
        <div>Or Add your own university to the platform: </div>



        <flux:input label="University" wire:model="createdUniversity" />
        <flux:input label="Faculty" wire:model="createdFaculty" />
        <flux:input label="Department" wire:model="createdDepartment" />

        <div class="pt-4">
            <button wire:click="addNewDepartment" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
                Add New Department
            </button>
        </div>
    </div>
