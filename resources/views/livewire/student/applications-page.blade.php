                    ...
                    @if (sizeOf($data) > 0)
                        @foreach ($data as $item)
                            <tr
                                ...
                                <td class=" py-4 font-medium flex justify-start items-center space-x-2">
                                    @if ($item->status == 'accepted')
                                        <flux:modal.trigger name="show-receipt">
                                            <flux:button :icon="'book-check'" class="hover:cursor-pointer" >
                                            </flux:button>
                                        </flux:modal.trigger>
                                        <flux:modal name="show-receipt" class="md:w-96">
                                            <div class="space-y-6">
                                                <div>
                                                    <flux:heading class="mb-3" size="lg">
                                                        {{ $item->internship->title }}
                                                    </flux:heading>
                                        ...
                                        <flux:button variant="primary" class="hover:cursor-pointer">Upload Certificat </flux:button>
